...
import { NULL, int8, uint8, int16, uint16, int32, uint32, int64, uint64, size_t, optval_t, pid_t, pointer_t, time_t } from './basetypes';
...
export declare const PATH_MAX = 4096;
export declare const isLE = true;
declare const timespecarr: import("../../typebase").Arr;
interface Itimespec extends Itimeval {
}
declare type Itimespecarr = [Itimespec, Itimespec];
export { SYS, MAP, FLAG, PROT, S, AMODE, SEEK, PF, AF, SOCK, IP, MCAST, SOL, SO, IPV6, IPPROTO, IPPORT, ERROR, MSG, SHUT, EPOLL_EVENTS, EPOLL, EPOLL_CTL, FCNTL, IPC, SHM, FD, DT, IN, NULL, int8, uint8, int16, uint16, int32, uint32, int64, uint64, size_t, optval_t, pid_t, pointer_t, time_t, ipv4, statStruct, IstatStruct, in_addr, Iin_addr, sockaddr_in, Isockaddr_in, sockaddr, Isockaddr, epoll_event, Iepoll_event, ipc_perm, Iipc_perm, shmid_ds, Ishmid_ds, utimbuf, Iutimbuf, timeval, Itimeval, timevalarr, Itimevalarr, timespec, timespecarr, Itimespecarr, linux_dirent64, Ilinux_dirent64, inotify_event, Iinotify_event, };
