...
function mmap(addr, length, prot, flags, fd, offset) {
    return libsys_1.libsys.syscall64(platform_1.SYS.mmap, addr, length, prot, flags, fd, offset);
}
exports.mmap = mmap;
// ### munmap
//
...
function munmap(addr, length) {
    return libsys_1.libsys.syscall(platform_1.SYS.munmap, addr, length);
}
...
function mprotect(addr, len, prot) {
    return libsys_1.libsys.syscall(platform_1.SYS.mprotect, addr, len, prot);
}
...
function shmget(key, size, shmflg) {
    return libsys_1.libsys.syscall(platform_1.SYS.shmget, key, size, shmflg);
}
 ...
 * @returns {number}
 */
function shmat(shmid, shmaddr = platform_1.NULL, shmflg = 0) {
    return libsys_1.libsys.syscall64(platform_1.SYS.shmat, shmid, shmaddr, shmflg);
}
exports.shmat = shmat;
// ### shmdt
//
...
function shmdt(shmaddr) {
    return libsys_1.libsys.syscall(platform_1.SYS.shmdt, shmaddr);
}
exports.shmdt = shmdt;
/**
 ...
 */
function shmctl(shmid, cmd, buf = platform_1.NULL) {
    ...
    return libsys_1.libsys.syscall(platform_1.SYS.shmctl, shmid, cmd, buf);
}
