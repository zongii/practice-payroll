...
function socket(domain, type, protocol) {
    return libsys_1.libsys.syscall(platform_1.SYS.socket, domain, type, protocol);
}
exports.socket = socket;
function socketAsync(domain, type, protocol, callback) {
    libsys_1.libsys.asyscall(platform_1.SYS.socket, domain, type, protocol, callback);
}
...
function connect(fd, sockaddr) {
    const buf = platform_1.sockaddr_in.pack(sockaddr);
    return libsys_1.libsys.syscall(platform_1.SYS.connect, fd, buf, buf.length);
}
exports.connect = connect;
function connectAsync(fd, sockaddr, callback) {
    const buf = platform_1.sockaddr_in.pack(sockaddr);
    libsys_1.libsys.asyscall(platform_1.SYS.connect, fd, buf, buf.length, callback);
}
...
function bind(fd, sockaddr, addr_type) {
    ...
    return libsys_1.libsys.syscall(platform_1.SYS.bind, fd, buf, buf.length);
}
exports.bind = bind;
function bindAsync(fd, sockaddr, addr_type, callback) {
    const buf = addr_type.pack(sockaddr);
    libsys_1.libsys.asyscall(platform_1.SYS.bind, fd, buf, buf.length, callback);
}
...
function listen(fd, backlog) {
    return libsys_1.libsys.syscall(platform_1.SYS.listen, fd, backlog);
}
exports.listen = listen;
function listenAsync(fd, backlog, callback) {
    libsys_1.libsys.asyscall(platform_1.SYS.listen, fd, backlog, callback);
}
...
function accept(fd, buf) {
    const buflen = platform_1.int32.pack(buf.length);
    return libsys_1.libsys.syscall(platform_1.SYS.accept, fd, buf, buflen);
}
exports.accept = accept;
function acceptAsync(fd, buf, callback) {
    const buflen = platform_1.int32.pack(buf.length);
    libsys_1.libsys.asyscall(platform_1.SYS.accept, fd, buf, buflen, callback);
}
exports.acceptAsync = acceptAsync;
function accept4(fd, buf, flags) {
    const buflen = platform_1.int32.pack(buf.length);
    return libsys_1.libsys.syscall(platform_1.SYS.accept4, fd, buf, buflen, flags);
}
exports.accept4 = accept4;
function accept4Async(fd, buf, flags, callback) {
    const buflen = platform_1.int32.pack(buf.length);
    libsys_1.libsys.asyscall(platform_1.SYS.accept4, fd, buf, buflen, flags, callback);
}
exports.accept4Async = accept4Async;
// ## shutdown
//
function shutdown(fd, how) {
    return libsys_1.libsys.syscall(platform_1.SYS.shutdown, fd, how);
}
exports.shutdown = shutdown;
function shutdownAsync(fd, how, callback) {
    libsys_1.libsys.asyscall(platform_1.SYS.shutdown, fd, how, callback);
}
...
//
function send(fd, buf, flags = 0) {
    return sendto(fd, buf, flags);
}
exports.send = send;
function sendAsync(fd, buf, flags = 0, callback) {
    sendtoAsync(fd, buf, flags, null, null, callback);
}
exports.sendAsync = sendAsync;
function sendto(fd, buf, flags = 0, addr, addr_type) {
...
function sendtoAsync(fd, buf, flags = 0, addr, addr_type, callback) {
    const params = [platform_1.SYS.sendto, fd, buf, buf.length, flags, 0, 0, callback];
    if (addr) {
        const addrbuf = addr_type.pack(addr);
        params[5] = addrbuf;
        params[6] = addrbuf.length;
    }
    libsys_1.libsys.syscall.apply(null, params);
}
...
//
function recv(sockfd, buf, flags = 0) {
    return recvfrom(sockfd, buf, buf.length, flags, 0, 0);
}
exports.recv = recv;
function recvfrom(sockfd, buf, len, flags, addr, addrlen) {
    return libsys_1.libsys.syscall(platform_1.SYS.recvfrom, sockfd, buf, len, flags, addr, addrlen);
}
...
function setsockopt(sockfd, level, optname, optval) {
    return libsys_1.libsys.syscall(platform_1.SYS.setsockopt, sockfd, level, optname, optval, optval.length);
}
